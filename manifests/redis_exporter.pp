...
class prometheus::redis_exporter (
  Array[String]    $addr                = $::prometheus::params::redis_exporter_redis_address,
  String           $arch                = $::prometheus::params::arch,
  String           $bin_dir             = $::prometheus::params::bin_dir,
  String           $download_extension  = $::prometheus::params::redis_exporter_download_extension,
  Optional[String] $download_url        = undef,
  String           $download_url_base   = $::prometheus::params::redis_exporter_download_url_base,
  Array[String]    $extra_groups        = $::prometheus::params::redis_exporter_extra_groups,
  String           $extra_options       = '',
  String           $group               = $::prometheus::params::redis_exporter_group,
  ...
  String           $package_ensure      = $::prometheus::params::redis_exporter_package_ensure,
  String           $package_name        = $::prometheus::params::redis_exporter_package_name,
  Boolean          $purge_config_dir    = true,
  Boolean          $restart_on_change   = true,
  Boolean          $service_enable      = true,
  String           $service_ensure      = 'running',
  String           $service_name        = 'redis_exporter',
  String           $user                = $::prometheus::params::redis_exporter_user,
  String           $version             = $::prometheus::params::redis_exporter_version,
